    ...
    <div id="templatemo_header">
      ...
      <div id="templatemo_slider"><span class="sliderframe"></span>
        <div class="slider-wrapper theme-orman">
          <div id="slider" class="nivoSlider" style="position: relative; background: url(&quot;images/slider/01.jpg&quot;) no-repeat;">
            <?php
            include "koneksi.php";
      ...
      <div class="templatemo_header_box right">
        <ul id="templatemo_menu">
          ...
          ?>
            ...
            <li><a href="index2.php?id= <?= $data['id']; ?>" class="selected home">
                <?= $data['kategori']; ?></a>
            </li>
